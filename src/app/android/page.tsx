...
export const metadata: Metadata = {
  title: 'Android | DivideAI',
  description: 'Baixe o APK do DivideAI para Android.',
}
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_0%_0%,#dcfce7_0%,#f0fdf4_32%,#ffffff_74%)]">
      <main className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-gray-900">DivideAI para Android</h1>
        ...
        <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-4 text-sm text-gray-600">
            Arquivo oficial: <span className="font-medium text-gray-800">divideai-beta.apk</span>
          </p>
        </div>
      </main>
    </div>
