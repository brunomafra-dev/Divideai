...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://rtnhmeadfjldpqrqqkvj.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ0bmhtZWFkZmpsZHBxcnFxa3ZqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE1MjM0MjksImV4cCI6MjA4NzA5OTQyOX0.LzpYBWaUyocq0TU-piHmfeVqtUoH7jENgYR6eykNL_w");
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const resolveValidUser = {
                "AuthProvider.useEffect.resolveValidUser": async (session)=>{
                    if (!session) return null;
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    if (error || !data.user) {
            ...
            }["AuthProvider.useEffect.resolveValidUser"];
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
                "AuthProvider.useEffect": async ({ data: { session } })=>{
                    const validUser = await resolveValidUser(session);
                    setSession(session);
                    setUser(validUser);
                    await ensureIdentity(validUser);
                    setLoading(false);
                }
            }["AuthProvider.useEffect"]);
...
function AuthGate({ children }) {
    ...
    const isPublicRoute = pathname === '/login' || pathname === '/signup' || pathname === '/register' || pathname === '/forgot-password' || pathname === '/reset-password';
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthGate.useEffect": ()=>{
            if (loading) return;
...
//# sourceMappingURL=src_1c6a7595._.js.map