...
function Activity() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const run = async ()=>{
            ...
            const { data: g } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('groups').select('id,name,participants');
            const safeGroups = g || [];
            const hydrated = await Promise.all(safeGroups.map(async (group)=>({
                    ...group,
            ...
            setGroups(hydrated);
            const { data: t } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('id,group_id,value,payer_id,created_at').order('created_at', {
                ascending: false
            }).limit(30);
            setTransactions((t || []).map((x)=>({
                    ...x,
                    value: Number(x.value) || 0
                })));
            const { data: p } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('payments').select('id,group_id,from_user,to_user,amount,created_at').order('created_at', {
                ascending: false
            }).limit(30);
            setPayments((p || []).map((x)=>({
                    ...x,
    ...
    const groupMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const m = new Map();
...
//# sourceMappingURL=src_db61958c._.js.map