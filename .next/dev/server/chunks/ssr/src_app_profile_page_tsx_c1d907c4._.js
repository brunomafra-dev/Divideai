...
function ProfilePage() {
    ...
    const loadProfile = async ()=>{
        try {
            ...
            const ensured = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$profiles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureProfileForUser"])(user);
            const resolved = {
                id: user.id,
                email: user.email || '',
    ...
    const handleSave = async ()=>{
        ...
        setSaving(true);
        try {
            const { data, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update({
