...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const run = async ()=>{
            ...
            const { data: groupRows, error: gErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('groups').select('id,name,participants');
            if (gErr) {
            ...
            let txRows = null;
            let tErr = null;
            const txWithAll = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('id,group_id,value,payer_id,participants,splits,status');
            if (txWithAll.error) {
            ...
            const hydratedGroups = await Promise.all(safeGroups.map(async (group)=>{
                const list = Array.isArray(group.participants) ? group.participants : [];
                return {
                    ...group,
                    participants: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$profiles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hydrateParticipantsWithProfiles"])(list)
                };
            }));
            ...
            let global = 0;
            const uiGroups = hydratedGroups.map((g)=>{
                const participantsArr = Array.isArray(g.participants) ? g.participants : [];
                const members = participantsArr.map((p)=>{
                    if (!p) return null;
...
//# sourceMappingURL=src_9af1d916._.js.map